...
const DashProfile = () => {
    ...
    const [imageFileUpoadError,setImageFileUpoadError]=useState(null)
        ...
        <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
          ...
          <input type='file' accept='images/.*'
           ...
           hidden/>
            ...
            {imageFileUpoadError && <Alert color='failure'>{imageFileUpoadError}</Alert>}
            <TextInput type='text'
              id='username'
